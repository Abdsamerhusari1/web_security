...
<body class="flex flex-col min-h-screen bg-gray-100">
    ...
    <div class="flex-grow container mx-auto px-4 mt-8">
        ...
        echo !empty($_GET['from']) ? '?from=' . htmlspecialchars($_GET['from']) : '';
        ?>" method="post" class="max-w-md mx-auto mt-4">
            <div class="mb-4">
                <label for="username" class="block text-gray-700 text-sm font-bold mb-2">Username:</label>
                <input type="text" id="username" name="username" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="<?php
